...
class FaqServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // register commands
        $this->registerCommands('\Modules\Faq\Console\Commands');
    }
    ...
    {
        $this->publishes([
            base_path('Modules/Faq/Config/config.php') => config_path($this->moduleNameLower.'.php'),
        ], 'config');
        $this->mergeConfigFrom(
            base_path('Modules/Faq/Config/config.php'), $this->moduleNameLower
        );
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = base_path('Modules/Faq/Resources/views');
